...
function reloadLottiePlayer() {
  ...
  lottiePlayer.remove();
  document.getElementById('lottie-player-wrapper').innerHTML = `<lottie-player id="lottie-player-src" src="${src}" background="transparent" speed="1"  autoplay="" style="width: 100%; height: 100%; min-height: ${lottiePlayerHeight}px;"></lottie-player>`;
}
